...
username = "dva_cafe_testing"
password = "tT5OEhVY4s7TCyCrKX3KbjPnWor0fGMhabPUI1AFTSM="
cluster_url = "mongodb-2.qa.datadelivery.info"
database_name = "n6_sme"
projection = {"_id": 1, "dataItemName": 1, "displayRootName": 1, "unitTypeId": 1}
collection_name = "dataitem_sn"
...
@scenario(r'mongodb/mongodb.feature', 'Check mongodb connection')
