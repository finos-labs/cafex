class InternetPage:
    ...
    a_or_b_testing_link = "xpath=//a[normalize-space()='A/B Testing']"
    a_or_b_testing_header = "xpath=/html/body/div[2]/div/div/h3"
    ...
    form_authentication_header = "xpath=//h2[normalize-space()='Login Page']"
